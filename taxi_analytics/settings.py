...
# constants for calculating order price
AVG_PETROL_PRICE_PER_LITER_RUB = 60
AVG_PETROL_CONSUMPTION_LITER_PER_KM = 0.1
OVERPRICE_PERCENT = 0.7
DRIVER_RATE_PER_MIN = 200 / 60  # 200 руб/ч
MAX_SURGE_VALUE = 5

# maps
YANDEX_MAPS_API_KEY = os.environ.get("YANDEX_MAPS_API_KEY", "<WRONG KEY>")
GRAPHHOPPER_API_KEY = os.environ.get("GRAPHHOPPER_API_KEY", "<OBVIOUSLY WRONG KEY>")
